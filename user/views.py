...
class TripDetailsView(View):
    ...
    def get(self, request, trip_id):
        cursor = connection.cursor()
        sql =   """
                SELECT TD.TRIP_ID, TD.CYCLE_ID, C.MODEL, O.OWNER_ID, O.OWNER_NAME, CS.CUSTOMER_ID, CS.CUSTOMER_NAME, TD.START_DATE_TIME, TD.END_DATE_TIME, TD.PAYMENT_TYPE, FARE_CALCULATION(TRIP_ID)
