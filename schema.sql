...
(
	...
	TOKEN_VALUE VARCHAR2(10),
	TOKEN_CREATED DATE,
	TOKEN_EXPIRY DATE,
	CONSTRAINT EMAIL_VER_PK PRIMARY KEY(EMAIL_ADDRESS)
);
...
(
	...
	CONSTRAINT OWNER_EMAIL_VER_FK FOREIGN KEY(EMAIL_ADDRESS) REFERENCES EMAIL_VERIFICATION(EMAIL_ADDRESS)
);
...
(
	...
	CONSTRAINT CUSTOMER_DOCUMENT_FK FOREIGN KEY(DOCUMENT_ID) REFERENCES DOCUMENT(DOCUMENT_ID),
	CONSTRAINT CUSTOMER_EMAIL_VER_FK FOREIGN KEY(EMAIL_ADDRESS) REFERENCES EMAIL_VERIFICATION(EMAIL_ADDRESS)
);
